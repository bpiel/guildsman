...
JNIEXPORT jlong JNICALL Java_com_billpiel_guildsman_TensorNI_allocate(JNIEnv* env,
                                                            jclass clazz,
                                                            jint dtype,
                                                            jlongArray shape,
                                                            jlong sizeInBytes) {
...
JNIEXPORT jlong JNICALL Java_com_billpiel_guildsman_TensorNI_allocateScalarBytes(
...
JNIEXPORT void JNICALL Java_com_billpiel_guildsman_TensorNI_delete(JNIEnv* env,
                                                         jclass clazz,
                                                         jlong handle) {
  if (handle == 0) return;
...
JNIEXPORT jobject JNICALL Java_com_billpiel_guildsman_TensorNI_buffer(JNIEnv* env,
                                                      jclass clazz,
                                                      jlong handle) {
...
JNIEXPORT jint JNICALL Java_com_billpiel_guildsman_TensorNI_dtype(JNIEnv* env,
                                                        jclass clazz,
                                                        jlong handle) {
...
JNIEXPORT jlongArray JNICALL Java_com_billpiel_guildsman_TensorNI_shape(JNIEnv* env,
                                                              jclass clazz,
                                                              jlong handle) {
  TF_Tensor* t = requireHandle(env, handle);
  if (t == nullptr) return nullptr;
...
JNIEXPORT void JNICALL Java_com_billpiel_guildsman_TensorNI_setValue(JNIEnv* env,
                                                           jclass clazz,
                                                           jlong handle,
                                                           jobject value) {
  TF_Tensor* t = requireHandle(env, handle);
...
#define DEFINE_GET_SCALAR_METHOD(jtype, dtype, method_suffix)                  \
  JNIEXPORT jtype JNICALL Java_com_billpiel_guildsman_TensorNI_scalar##method_suffix(    \
...
JNIEXPORT jbyteArray JNICALL Java_com_billpiel_guildsman_TensorNI_scalarBytes(
    JNIEnv* env, jclass clazz, jlong handle) {
  TF_Tensor* t = requireHandle(env, handle);
  if (t == nullptr) return nullptr;
  if (TF_NumDims(t) != 0) {
...
JNIEXPORT void JNICALL Java_com_billpiel_guildsman_TensorNI_readNDArray(JNIEnv* env,
                                                              jclass clazz,
                                                              jlong handle,
                                                              jobject value) {
  TF_Tensor* t = requireHandle(env, handle);
