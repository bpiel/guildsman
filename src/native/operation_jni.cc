...
JNIEXPORT jstring JNICALL Java_com_billpiel_guildsman_OperationNI_name(JNIEnv* env,
                                                             jclass clazz,
                                                             jlong handle) {
...
JNIEXPORT jstring JNICALL Java_com_billpiel_guildsman_OperationNI_type(JNIEnv* env,
                                                             jclass clazz,
                                                             jlong handle) {
  TF_Operation* op = requireHandle(env, handle);
  if (op == nullptr) return nullptr;
...
JNIEXPORT jint JNICALL Java_com_billpiel_guildsman_OperationNI_numOutputs(JNIEnv* env,
                                                                jclass clazz,
                                                                jlong handle) {
  TF_Operation* op = requireHandle(env, handle);
...
JNIEXPORT jint JNICALL Java_com_billpiel_guildsman_OperationNI_outputListLength(JNIEnv* env,
                                                                      jclass clazz,
                                                                      jlong handle,
                                                                      jstring name) {
  TF_Operation* op = requireHandle(env, handle);
...
JNIEXPORT jlongArray JNICALL Java_com_billpiel_guildsman_OperationNI_shape(
...
JNIEXPORT jint JNICALL Java_com_billpiel_guildsman_OperationNI_dtype(JNIEnv* env,
                                                           jclass clazz,
                                                           jlong graph_handle,
                                                           jlong op_handle,
                                                           jint output_index) {
...
JNIEXPORT jbyteArray JNICALL Java_com_billpiel_guildsman_OperationNI_toNodeDef(JNIEnv* env,
                                                           jclass clazz,
                                                           jlong handle){
...
JNIEXPORT jint JNICALL Java_com_billpiel_guildsman_OperationNI_inputListLength(JNIEnv* env,
                                                               jclass clazz,
                                                               jlong handle,
                                                               jstring name) {
  TF_Operation* op = requireHandle(env, handle);
