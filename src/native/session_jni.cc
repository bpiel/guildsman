...
JNIEXPORT jlong JNICALL Java_com_billpiel_guildsman_SessionNI_allocate(
    JNIEnv* env, jclass clazz, jlong graph_handle) {
  return Java_com_billpiel_guildsman_SessionNI_allocate2(env, clazz, graph_handle,
                                               nullptr, nullptr);
}

JNIEXPORT jlong JNICALL Java_com_billpiel_guildsman_SessionNI_allocate2(
...
JNIEXPORT void JNICALL Java_com_billpiel_guildsman_SessionNI_delete(JNIEnv* env,
                                                          jclass clazz,
                                                          jlong handle) {
...
JNIEXPORT jbyteArray JNICALL Java_com_billpiel_guildsman_SessionNI_run(
