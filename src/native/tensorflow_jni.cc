...
JNIEXPORT jstring JNICALL Java_com_billpiel_guildsman_TensorFlowNI_version(JNIEnv* env,
                                                                 jclass clazz) {
  return env->NewStringUTF(TF_Version());
}

JNIEXPORT jbyteArray JNICALL
Java_com_billpiel_guildsman_TensorFlowNI_registeredOpList(JNIEnv* env, jclass clazz) {
