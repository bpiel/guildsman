...
var vec__70335_70338 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_70339 = cljs.core.nth.call(null,vec__70335_70338,(0),null);
var only_after_70340 = cljs.core.nth.call(null,vec__70335_70338,(1),null);
var db_changed_QMARK__70341 = (!((only_before_70339 == null))) || (!((only_after_70340 == null)));
if(db_changed_QMARK__70341){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_70339);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_70340);
...
var map__70342 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__70342__$1 = ((((!((map__70342 == null)))?((((map__70342.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__70342.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__70342):map__70342);
var db = cljs.core.get.call(null,map__70342__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__70342__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__70344 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__70344__$1 = ((((!((map__70344 == null)))?((((map__70344.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__70344.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__70344):map__70344);
var coeffects = map__70344__$1;
var event = cljs.core.get.call(null,map__70344__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__64038__auto___70347 = arguments.length;
var i__64039__auto___70348 = (0);
while(true){
if((i__64039__auto___70348 < len__64038__auto___70347)){
args__64045__auto__.push((arguments[i__64039__auto___70348]));

var G__70349 = (i__64039__auto___70348 + (1));
i__64039__auto___70348 = G__70349;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__64046__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq70346){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq70346));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__62761__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__64045__auto__ = [];
var len__64038__auto___70355 = arguments.length;
var i__64039__auto___70356 = (0);
while(true){
if((i__64039__auto___70356 < len__64038__auto___70355)){
args__64045__auto__.push((arguments[i__64039__auto___70356]));

var G__70357 = (i__64039__auto___70356 + (1));
i__64039__auto___70356 = G__70357;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__64046__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__70350_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__70351_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__70351_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__62749__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq70352){
var G__70353 = cljs.core.first.call(null,seq70352);
var seq70352__$1 = cljs.core.next.call(null,seq70352);
var G__70354 = cljs.core.first.call(null,seq70352__$1);
var seq70352__$2 = cljs.core.next.call(null,seq70352__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__70353,G__70354,seq70352__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1514950331136
