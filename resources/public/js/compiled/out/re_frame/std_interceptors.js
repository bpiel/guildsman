...
var vec__19056_19059 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_19060 = cljs.core.nth.call(null,vec__19056_19059,(0),null);
var only_after_19061 = cljs.core.nth.call(null,vec__19056_19059,(1),null);
var db_changed_QMARK__19062 = (!((only_before_19060 == null))) || (!((only_after_19061 == null)));
if(db_changed_QMARK__19062){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_19060);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_19061);
...
var map__19063 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__19063__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__19063__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__19065 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__19065__$1;
var event = cljs.core.get.call(null,map__19065__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__11227__auto___19068 = arguments.length;
var i__11228__auto___19069 = (0);
while(true){
if((i__11228__auto___19069 < len__11227__auto___19068)){
args__11234__auto__.push((arguments[i__11228__auto___19069]));

var G__19070 = (i__11228__auto___19069 + (1));
i__11228__auto___19069 = G__19070;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__11235__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq19067){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq19067));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__9950__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__11234__auto__ = [];
var len__11227__auto___19076 = arguments.length;
var i__11228__auto___19077 = (0);
while(true){
if((i__11228__auto___19077 < len__11227__auto___19076)){
args__11234__auto__.push((arguments[i__11228__auto___19077]));

var G__19078 = (i__11228__auto___19077 + (1));
i__11228__auto___19077 = G__19078;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__11235__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__19071_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__19072_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__19072_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__9938__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq19073){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__19074,G__19075,seq19073__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1506917870875
