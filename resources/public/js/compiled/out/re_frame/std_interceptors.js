...
var vec__16629_16632 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_16633 = cljs.core.nth.call(null,vec__16629_16632,(0),null);
var only_after_16634 = cljs.core.nth.call(null,vec__16629_16632,(1),null);
var db_changed_QMARK__16635 = (!((only_before_16633 == null))) || (!((only_after_16634 == null)));
if(db_changed_QMARK__16635){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_16633);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_16634);
...
var map__16636 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__16636__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__16636__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__16638 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__16638__$1;
var event = cljs.core.get.call(null,map__16638__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__9636__auto___16641 = arguments.length;
var i__9637__auto___16642 = (0);
while(true){
if((i__9637__auto___16642 < len__9636__auto___16641)){
args__9643__auto__.push((arguments[i__9637__auto___16642]));

var G__16643 = (i__9637__auto___16642 + (1));
i__9637__auto___16642 = G__16643;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__9644__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq16640){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq16640));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__8359__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__9643__auto__ = [];
var len__9636__auto___16649 = arguments.length;
var i__9637__auto___16650 = (0);
while(true){
if((i__9637__auto___16650 < len__9636__auto___16649)){
args__9643__auto__.push((arguments[i__9637__auto___16650]));

var G__16651 = (i__9637__auto___16650 + (1));
i__9637__auto___16650 = G__16651;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__9644__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__16644_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__16645_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__16645_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__8347__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq16646){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__16647,G__16648,seq16646__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1521112591134
