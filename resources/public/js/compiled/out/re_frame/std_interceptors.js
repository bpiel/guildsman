...
var vec__61448_61451 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_61452 = cljs.core.nth.call(null,vec__61448_61451,(0),null);
var only_after_61453 = cljs.core.nth.call(null,vec__61448_61451,(1),null);
var db_changed_QMARK__61454 = (!((only_before_61452 == null))) || (!((only_after_61453 == null)));
if(db_changed_QMARK__61454){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_61452);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_61453);
...
var map__61455 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__61455__$1 = ((((!((map__61455 == null)))?((((map__61455.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61455.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__61455):map__61455);
var db = cljs.core.get.call(null,map__61455__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__61455__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__61457 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__61457__$1;
var event = cljs.core.get.call(null,map__61457__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__54247__auto___61460 = arguments.length;
var i__54248__auto___61461 = (0);
while(true){
if((i__54248__auto___61461 < len__54247__auto___61460)){
args__54254__auto__.push((arguments[i__54248__auto___61461]));

var G__61462 = (i__54248__auto___61461 + (1));
i__54248__auto___61461 = G__61462;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__54255__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq61459){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq61459));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__52970__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__54254__auto__ = [];
var len__54247__auto___61468 = arguments.length;
var i__54248__auto___61469 = (0);
while(true){
if((i__54248__auto___61469 < len__54247__auto___61468)){
args__54254__auto__.push((arguments[i__54248__auto___61469]));

var G__61470 = (i__54248__auto___61469 + (1));
i__54248__auto___61469 = G__61470;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__54255__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__61463_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__61464_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__61464_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__52958__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq61465){
var G__61466 = cljs.core.first.call(null,seq61465);
var seq61465__$1 = cljs.core.next.call(null,seq61465);
var G__61467 = cljs.core.first.call(null,seq61465__$1);
var seq61465__$2 = cljs.core.next.call(null,seq61465__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__61466,G__61467,seq61465__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1524702419467
