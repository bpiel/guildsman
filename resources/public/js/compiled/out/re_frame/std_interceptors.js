...
var vec__82474_82477 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_82478 = cljs.core.nth.call(null,vec__82474_82477,(0),null);
var only_after_82479 = cljs.core.nth.call(null,vec__82474_82477,(1),null);
var db_changed_QMARK__82480 = (!((only_before_82478 == null))) || (!((only_after_82479 == null)));
if(db_changed_QMARK__82480){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_82478);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_82479);
...
var map__82481 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__82481__$1 = ((((!((map__82481 == null)))?((((map__82481.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__82481.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__82481):map__82481);
var db = cljs.core.get.call(null,map__82481__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__82481__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__82483 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__82483__$1 = ((((!((map__82483 == null)))?((((map__82483.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__82483.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__82483):map__82483);
var coeffects = map__82483__$1;
var event = cljs.core.get.call(null,map__82483__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__76178__auto___82486 = arguments.length;
var i__76179__auto___82487 = (0);
while(true){
if((i__76179__auto___82487 < len__76178__auto___82486)){
args__76185__auto__.push((arguments[i__76179__auto___82487]));

var G__82488 = (i__76179__auto___82487 + (1));
i__76179__auto___82487 = G__82488;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__76186__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq82485){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq82485));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__74901__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__76185__auto__ = [];
var len__76178__auto___82494 = arguments.length;
var i__76179__auto___82495 = (0);
while(true){
if((i__76179__auto___82495 < len__76178__auto___82494)){
args__76185__auto__.push((arguments[i__76179__auto___82495]));

var G__82496 = (i__76179__auto___82495 + (1));
i__76179__auto___82495 = G__82496;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__76186__auto__);
});
...
return (function (p1__82489_SHARP_){
return cljs.core.get_in.call(null,new_db,p1__82489_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__82490_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__82490_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__74889__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq82491){
var G__82492 = cljs.core.first.call(null,seq82491);
var seq82491__$1 = cljs.core.next.call(null,seq82491);
var G__82493 = cljs.core.first.call(null,seq82491__$1);
var seq82491__$2 = cljs.core.next.call(null,seq82491__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__82492,G__82493,seq82491__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1515122952757
