...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__82043 = cljs.core.instance_QMARK_;
var expr__82044 = reactive_val;
if(cljs.core.truth_(pred__82043.call(null,reagent.ratom.RAtom,expr__82044))){
return "ra";
} else {
if(cljs.core.truth_(pred__82043.call(null,reagent.ratom.RCursor,expr__82044))){
return "rc";
} else {
if(cljs.core.truth_(pred__82043.call(null,reagent.ratom.Reaction,expr__82044))){
return "rx";
} else {
if(cljs.core.truth_(pred__82043.call(null,reagent.ratom.Track,expr__82044))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1515122951945
