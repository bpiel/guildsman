...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__61017 = cljs.core.instance_QMARK_;
var expr__61018 = reactive_val;
if(cljs.core.truth_(pred__61017.call(null,reagent.ratom.RAtom,expr__61018))){
return "ra";
} else {
if(cljs.core.truth_(pred__61017.call(null,reagent.ratom.RCursor,expr__61018))){
return "rc";
} else {
if(cljs.core.truth_(pred__61017.call(null,reagent.ratom.Reaction,expr__61018))){
return "rx";
} else {
if(cljs.core.truth_(pred__61017.call(null,reagent.ratom.Track,expr__61018))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1524702419096
