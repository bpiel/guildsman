...
var base_style__$1 = (cljs.core.truth_((function (){var and__9798__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__9798__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__9798__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__18115){
...
var args = map__18116__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__18116__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__18116__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__18116__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__18116__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__18116__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__18116__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__18116__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__18116__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__18116__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__18116__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__18116__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__18116,map__18116__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__18112_SHARP_){
return item_renderer.call(null,p1__18112_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__18116,map__18116__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__18116,map__18116__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__18113_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__18113_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__18116,map__18116__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__18116,map__18116__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__18114_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__18114_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__18116,map__18116__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__11087__auto___18125 = arguments.length;
var i__11088__auto___18126 = (0);
while(true){
if((i__11088__auto___18126 < len__11087__auto___18125)){
args__11094__auto__.push((arguments[i__11088__auto___18126]));

var G__18127 = (i__11088__auto___18126 + (1));
i__11088__auto___18126 = G__18127;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__11095__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__18119){
...
var args = map__18120__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__18120,map__18120__$1,args){
return (function() { 
var G__18128__delegate = function (p__18122){
var map__18123 = p__18122;
var map__18123__$1 = ((((!((map__18123 == null)))?((((map__18123.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__18123.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__18123):map__18123);
var args__$1 = map__18123__$1;
...
while (G__18129__i < G__18129__a.length) {G__18129__a[G__18129__i] = arguments[G__18129__i + 0]; ++G__18129__i;}
  p__18122 = new cljs.core.IndexedSeq(G__18129__a,0,null);
} 
return G__18128__delegate.call(this,p__18122);};
G__18128.cljs$lang$maxFixedArity = 0;
G__18128.cljs$lang$applyTo = (function (arglist__18130){
var p__18122 = cljs.core.seq(arglist__18130);
return G__18128__delegate(p__18122);
});
G__18128.cljs$core$IFn$_invoke$arity$variadic = G__18128__delegate;
return G__18128;
})()
;
;})(map__18120,map__18120__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq18118){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq18118));
});


//# sourceMappingURL=selection_list.js.map?rel=1506896677388
