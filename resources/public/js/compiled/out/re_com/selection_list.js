...
var base_style__$1 = (cljs.core.truth_((function (){var and__9938__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__9938__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__9938__auto__)){
...
if(cljs.core.truth_((function (){var and__9938__auto__ = required_QMARK_;
if(cljs.core.truth_(and__9938__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__18228){
...
var args = map__18229__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__18229__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__18229__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var height = cljs.core.get.call(null,map__18229__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var item_renderer = cljs.core.get.call(null,map__18229__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__18229__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__18229__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__18229__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__18229__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var max_height = cljs.core.get.call(null,map__18229__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var hide_border_QMARK_ = cljs.core.get.call(null,map__18229__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var width = cljs.core.get.call(null,map__18229__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var choices = cljs.core.get.call(null,map__18229__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__18229__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__18229__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__18229,map__18229__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__18225_SHARP_){
return item_renderer.call(null,p1__18225_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__18229,map__18229__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__18229,map__18229__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__18226_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__18226_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__18229,map__18229__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__18229,map__18229__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__18227_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__18227_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__18229,map__18229__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__11227__auto___18238 = arguments.length;
var i__11228__auto___18239 = (0);
while(true){
if((i__11228__auto___18239 < len__11227__auto___18238)){
args__11234__auto__.push((arguments[i__11228__auto___18239]));

var G__18240 = (i__11228__auto___18239 + (1));
i__11228__auto___18239 = G__18240;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__11235__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__18232){
var map__18233 = p__18232;
var map__18233__$1 = ((((!((map__18233 == null)))?((((map__18233.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__18233.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__18233):map__18233);
var args = map__18233__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__18233,map__18233__$1,args){
return (function() { 
var G__18241__delegate = function (p__18235){
...
while (G__18242__i < G__18242__a.length) {G__18242__a[G__18242__i] = arguments[G__18242__i + 0]; ++G__18242__i;}
  p__18235 = new cljs.core.IndexedSeq(G__18242__a,0,null);
} 
return G__18241__delegate.call(this,p__18235);};
G__18241.cljs$lang$maxFixedArity = 0;
G__18241.cljs$lang$applyTo = (function (arglist__18243){
var p__18235 = cljs.core.seq(arglist__18243);
return G__18241__delegate(p__18235);
});
G__18241.cljs$core$IFn$_invoke$arity$variadic = G__18241__delegate;
return G__18241;
})()
;
;})(map__18233,map__18233__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq18231){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq18231));
});


//# sourceMappingURL=selection_list.js.map?rel=1506917869869
