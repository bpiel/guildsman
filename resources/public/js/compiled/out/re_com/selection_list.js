...
var base_style__$1 = (cljs.core.truth_((function (){var and__52958__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__52958__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__52958__auto__)){
...
if(cljs.core.truth_((function (){var and__52958__auto__ = required_QMARK_;
if(cljs.core.truth_(and__52958__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__60917){
var map__60918 = p__60917;
var map__60918__$1 = ((((!((map__60918 == null)))?((((map__60918.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__60918.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__60918):map__60918);
var args = map__60918__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__60918__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__60918__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var height = cljs.core.get.call(null,map__60918__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var item_renderer = cljs.core.get.call(null,map__60918__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__60918__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__60918__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__60918__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__60918__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var max_height = cljs.core.get.call(null,map__60918__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var hide_border_QMARK_ = cljs.core.get.call(null,map__60918__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var width = cljs.core.get.call(null,map__60918__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var choices = cljs.core.get.call(null,map__60918__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__60918__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__60918__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__60918,map__60918__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__60914_SHARP_){
return item_renderer.call(null,p1__60914_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__60918,map__60918__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__60918,map__60918__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__60915_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__60915_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__60918,map__60918__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__60918,map__60918__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__60916_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__60916_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__60918,map__60918__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__54247__auto___60927 = arguments.length;
var i__54248__auto___60928 = (0);
while(true){
if((i__54248__auto___60928 < len__54247__auto___60927)){
args__54254__auto__.push((arguments[i__54248__auto___60928]));

var G__60929 = (i__54248__auto___60928 + (1));
i__54248__auto___60928 = G__60929;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__54255__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__60921){
...
var args = map__60922__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__60922,map__60922__$1,args){
return (function() { 
var G__60930__delegate = function (p__60924){
var map__60925 = p__60924;
var map__60925__$1 = ((((!((map__60925 == null)))?((((map__60925.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__60925.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__60925):map__60925);
var args__$1 = map__60925__$1;
...
while (G__60931__i < G__60931__a.length) {G__60931__a[G__60931__i] = arguments[G__60931__i + 0]; ++G__60931__i;}
  p__60924 = new cljs.core.IndexedSeq(G__60931__a,0,null);
} 
return G__60930__delegate.call(this,p__60924);};
G__60930.cljs$lang$maxFixedArity = 0;
G__60930.cljs$lang$applyTo = (function (arglist__60932){
var p__60924 = cljs.core.seq(arglist__60932);
return G__60930__delegate(p__60924);
});
G__60930.cljs$core$IFn$_invoke$arity$variadic = G__60930__delegate;
return G__60930;
})()
;
;})(map__60922,map__60922__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq60920){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq60920));
});


//# sourceMappingURL=selection_list.js.map?rel=1524702418844
