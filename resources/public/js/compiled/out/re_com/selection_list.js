...
var base_style__$1 = (cljs.core.truth_((function (){var and__74889__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__74889__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__74889__auto__)){
...
if(cljs.core.truth_((function (){var and__74889__auto__ = required_QMARK_;
if(cljs.core.truth_(and__74889__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__81943){
...
var args = map__81944__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__81944__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__81944__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var height = cljs.core.get.call(null,map__81944__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var item_renderer = cljs.core.get.call(null,map__81944__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__81944__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__81944__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__81944__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__81944__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var max_height = cljs.core.get.call(null,map__81944__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var hide_border_QMARK_ = cljs.core.get.call(null,map__81944__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var width = cljs.core.get.call(null,map__81944__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var choices = cljs.core.get.call(null,map__81944__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__81944__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__81944__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__81944,map__81944__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__81940_SHARP_){
return item_renderer.call(null,p1__81940_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__81944,map__81944__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__81944,map__81944__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__81941_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__81941_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__81944,map__81944__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__81944,map__81944__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__81942_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__81942_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__81944,map__81944__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__76178__auto___81953 = arguments.length;
var i__76179__auto___81954 = (0);
while(true){
if((i__76179__auto___81954 < len__76178__auto___81953)){
args__76185__auto__.push((arguments[i__76179__auto___81954]));

var G__81955 = (i__76179__auto___81954 + (1));
i__76179__auto___81954 = G__81955;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__76186__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__81947){
var map__81948 = p__81947;
...
var args = map__81948__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__81948,map__81948__$1,args){
return (function() { 
var G__81956__delegate = function (p__81950){
var map__81951 = p__81950;
var map__81951__$1 = ((((!((map__81951 == null)))?((((map__81951.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__81951.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__81951):map__81951);
var args__$1 = map__81951__$1;
...
var G__81956 = function (var_args){
var p__81950 = null;
...
while (G__81957__i < G__81957__a.length) {G__81957__a[G__81957__i] = arguments[G__81957__i + 0]; ++G__81957__i;}
  p__81950 = new cljs.core.IndexedSeq(G__81957__a,0,null);
} 
return G__81956__delegate.call(this,p__81950);};
G__81956.cljs$lang$maxFixedArity = 0;
G__81956.cljs$lang$applyTo = (function (arglist__81958){
var p__81950 = cljs.core.seq(arglist__81958);
return G__81956__delegate(p__81950);
});
G__81956.cljs$core$IFn$_invoke$arity$variadic = G__81956__delegate;
return G__81956;
})()
;
;})(map__81948,map__81948__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq81946){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq81946));
});


//# sourceMappingURL=selection_list.js.map?rel=1515122951391
