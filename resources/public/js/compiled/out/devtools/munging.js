...
var o67710 = temp__5455__auto__;
var temp__5455__auto____$1 = (o67710["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o67711 = temp__5455__auto____$1;
return (o67711["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__61839__auto__ = f;
return (o__61839__auto__["toString"]).call(o__61839__auto__);
} else {
return "";
}
}catch (e67712){var _ = e67712;
return "";
}});
...
try{var o__61839__auto___67714 = t;
(o__61839__auto___67714["cljs$lang$ctorPrWriter"]).call(o__61839__auto___67714,t,writer);
}catch (e67713){var __67715 = e67713;
}
...
var char_code = (function (){var o__61839__auto__ = (new String(char$));
return (o__61839__auto__["charCodeAt"]).call(o__61839__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__61839__auto__ = String;
return (o__61839__auto__["fromCharCode"]).call(o__61839__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__67716 = num_code;
switch (G__67716) {
case (1):
return (185);
...
var o__61839__auto__ = String;
return (o__61839__auto__["fromCharCode"]).call(o__61839__auto__,superscript_code);
});
/**
...
}catch (e67718){var _e__61846__auto__ = e67718;
return false;
}})())){
...
var vec__67719 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__67719,(0),null);
...
var or__52970__auto__ = (function (){var temp__5455__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5455__auto__)){
...
if(cljs.core.truth_(temp__5455__auto__)){
var o67722 = temp__5455__auto__;
var temp__5455__auto____$1 = (o67722["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o67723 = temp__5455__auto____$1;
return (o67723["nameToPath"]);
} else {
return null;
}
} else {
...
var len__54247__auto___67730 = arguments.length;
var i__54248__auto___67731 = (0);
while(true){
if((i__54248__auto___67731 < len__54247__auto___67730)){
args__54254__auto__.push((arguments[i__54248__auto___67731]));

var G__67732 = (i__54248__auto___67731 + (1));
i__54248__auto___67731 = G__67732;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__54255__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__67726){
var vec__67727 = p__67726;
var ns_detector = cljs.core.nth.call(null,vec__67727,(0),null);
var effective_detector = (function (){var or__52970__auto__ = ns_detector;
if(cljs.core.truth_(or__52970__auto__)){
return or__52970__auto__;
} else {
...
var G__67733 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__67734 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__67733;
remaining_tokens = G__67734;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq67724){
var G__67725 = cljs.core.first.call(null,seq67724);
var seq67724__$1 = cljs.core.next.call(null,seq67724);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__67725,seq67724__$1);
});
...
var vec__67738 = cljs.core.split_with.call(null,(function (p1__67737_SHARP_){
return cljs.core.not_EQ_.call(null,p1__67737_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__67738,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__67738,(1),null);
...
var vec__67741 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__67741,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__67741,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__67744 = cljs.core.rest.call(null,remaining_tokens);
var G__67745 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__67744;
name_tokens = G__67745;
continue;
} else {
...
var vec__67748 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__67748,(0),null);
var arity = cljs.core.nth.call(null,vec__67748,(1),null);
var vec__67751 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__67751,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__67751,(1),null);
var vec__67754 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__67754,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__67754,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__67754,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__67754,(3),null);
...
var vec__67760 = result;
var munged_ns = cljs.core.nth.call(null,vec__67760,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__67760,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__67760,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__67760,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__67760,(4),null);
var arity = cljs.core.nth.call(null,vec__67760,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__67764 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__67764,(0),null);
var args = cljs.core.nth.call(null,vec__67764,(1),null);
var vec__67767 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__67767,(0),null);
var name = cljs.core.nth.call(null,vec__67767,(1),null);
...
var G__67771 = (arity + (1));
var G__67772 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__67773){
var vec__67774 = p__67773;
var arity = cljs.core.nth.call(null,vec__67774,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__67774,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__52970__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__52970__auto__)){
return or__52970__auto__;
} else {
...
return (function (p1__67777_SHARP_){
return cljs.core.get.call(null,arities,p1__67777_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__67778_SHARP_);
...
var args__54254__auto__ = [];
var len__54247__auto___67785 = arguments.length;
var i__54248__auto___67786 = (0);
while(true){
if((i__54248__auto___67786 < len__54247__auto___67785)){
args__54254__auto__.push((arguments[i__54248__auto___67786]));

var G__67787 = (i__54248__auto___67786 + (1));
i__54248__auto___67786 = G__67787;
continue;
} else {
}
break;
...
var argseq__54255__auto__ = ((((1) < args__54254__auto__.length))?(new cljs.core.IndexedSeq(args__54254__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__54255__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__67781){
var vec__67782 = p__67781;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__67782,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq67779){
var G__67780 = cljs.core.first.call(null,seq67779);
var seq67779__$1 = cljs.core.next.call(null,seq67779);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__67780,seq67779__$1);
});
...
var G__67788 = arg;
var G__67788__$1 = (((G__67788 instanceof cljs.core.Keyword))?G__67788.fqn:null);
switch (G__67788__$1) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__52970__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__52970__auto__)){
return or__52970__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__52958__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__52970__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__52970__auto__)){
return or__52970__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__67790__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__67790__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__67790__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__67790__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__67791 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__67791,(0),null);
var fn_name = cljs.core.nth.call(null,vec__67791,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__67791,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__67791,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__67791,(4),null);
var arity = cljs.core.nth.call(null,vec__67791,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__52958__auto__ = protocol_ns;
if(cljs.core.truth_(and__52958__auto__)){
return cljs.core.not.call(null,(function (){var and__52958__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__52970__auto__ = protocol_part;
if(cljs.core.truth_(or__52970__auto__)){
return or__52970__auto__;
} else {
return fn_part;
...
var o__61839__auto__ = f;
return (o__61839__auto__["getBasis"]).call(o__61839__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__52958__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__52958__auto__)){
...
}catch (e67795){var _e__61846__auto__ = e67795;
...
var G__67796 = (obj[cljs.core.first.call(null,path)]);
var G__67797 = cljs.core.rest.call(null,path);
obj = G__67796;
path = G__67797;
continue;
} else {
...
var partition_bits = (function (){var or__52970__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__52970__auto__)){
return or__52970__auto__;
} else {
return (0);
...
return (function (accum,p__67798){
var vec__67799 = p__67798;
var bit = cljs.core.nth.call(null,vec__67799,(0),null);
var protocol = cljs.core.nth.call(null,vec__67799,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__67802){
var vec__67803 = p__67802;
var ns = cljs.core.nth.call(null,vec__67803,(0),null);
var name = cljs.core.nth.call(null,vec__67803,(1),null);
var selector = cljs.core.nth.call(null,vec__67803,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__67808,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__67808,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__67808,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__67806_SHARP_){
return (obj[cljs.core.first.call(null,p1__67806_SHARP_)]);
});})(name,sorted_matches,vec__67808,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1524702425167
