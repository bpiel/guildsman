...
var o88420 = temp__5455__auto__;
var temp__5455__auto____$1 = (o88420["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o88421 = temp__5455__auto____$1;
return (o88421["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__82865__auto__ = f;
return (o__82865__auto__["toString"]).call(o__82865__auto__);
} else {
return "";
}
}catch (e88422){var _ = e88422;
return "";
}});
...
try{var o__82865__auto___88424 = t;
(o__82865__auto___88424["cljs$lang$ctorPrWriter"]).call(o__82865__auto___88424,t,writer);
}catch (e88423){var __88425 = e88423;
}
...
var char_code = (function (){var o__82865__auto__ = (new String(char$));
return (o__82865__auto__["charCodeAt"]).call(o__82865__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__82865__auto__ = String;
return (o__82865__auto__["fromCharCode"]).call(o__82865__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__88426 = num_code;
switch (G__88426) {
case (1):
return (185);
...
var o__82865__auto__ = String;
return (o__82865__auto__["fromCharCode"]).call(o__82865__auto__,superscript_code);
});
/**
...
}catch (e88428){var _e__82872__auto__ = e88428;
return false;
}})())){
...
var vec__88429 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__88429,(0),null);
...
var or__74901__auto__ = (function (){var temp__5455__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5455__auto__)){
...
if(cljs.core.truth_(temp__5455__auto__)){
var o88432 = temp__5455__auto__;
var temp__5455__auto____$1 = (o88432["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o88433 = temp__5455__auto____$1;
return (o88433["nameToPath"]);
} else {
return null;
}
} else {
...
var len__76178__auto___88440 = arguments.length;
var i__76179__auto___88441 = (0);
while(true){
if((i__76179__auto___88441 < len__76178__auto___88440)){
args__76185__auto__.push((arguments[i__76179__auto___88441]));

var G__88442 = (i__76179__auto___88441 + (1));
i__76179__auto___88441 = G__88442;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__76186__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__88436){
var vec__88437 = p__88436;
var ns_detector = cljs.core.nth.call(null,vec__88437,(0),null);
var effective_detector = (function (){var or__74901__auto__ = ns_detector;
if(cljs.core.truth_(or__74901__auto__)){
return or__74901__auto__;
} else {
...
var G__88443 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__88444 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__88443;
remaining_tokens = G__88444;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq88434){
var G__88435 = cljs.core.first.call(null,seq88434);
var seq88434__$1 = cljs.core.next.call(null,seq88434);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__88435,seq88434__$1);
});
...
var vec__88448 = cljs.core.split_with.call(null,(function (p1__88447_SHARP_){
return cljs.core.not_EQ_.call(null,p1__88447_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__88448,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__88448,(1),null);
...
var vec__88451 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__88451,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__88451,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__88454 = cljs.core.rest.call(null,remaining_tokens);
var G__88455 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__88454;
name_tokens = G__88455;
continue;
} else {
...
var vec__88458 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__88458,(0),null);
var arity = cljs.core.nth.call(null,vec__88458,(1),null);
var vec__88461 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__88461,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__88461,(1),null);
var vec__88464 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__88464,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__88464,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__88464,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__88464,(3),null);
...
var vec__88470 = result;
var munged_ns = cljs.core.nth.call(null,vec__88470,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__88470,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__88470,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__88470,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__88470,(4),null);
var arity = cljs.core.nth.call(null,vec__88470,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__88474 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__88474,(0),null);
var args = cljs.core.nth.call(null,vec__88474,(1),null);
var vec__88477 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__88477,(0),null);
var name = cljs.core.nth.call(null,vec__88477,(1),null);
...
var G__88480 = (arity + (1));
var G__88481 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__88482){
var vec__88483 = p__88482;
var arity = cljs.core.nth.call(null,vec__88483,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__88483,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__74901__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__74901__auto__)){
return or__74901__auto__;
} else {
...
return (function (p1__88486_SHARP_){
return cljs.core.get.call(null,arities,p1__88486_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__88487_SHARP_){
return cljs.core.drop.call(null,(2),p1__88487_SHARP_);
...
var args__76185__auto__ = [];
var len__76178__auto___88494 = arguments.length;
var i__76179__auto___88495 = (0);
while(true){
if((i__76179__auto___88495 < len__76178__auto___88494)){
args__76185__auto__.push((arguments[i__76179__auto___88495]));

var G__88496 = (i__76179__auto___88495 + (1));
i__76179__auto___88495 = G__88496;
continue;
} else {
}
break;
...
var argseq__76186__auto__ = ((((1) < args__76185__auto__.length))?(new cljs.core.IndexedSeq(args__76185__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__76186__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__88490){
var vec__88491 = p__88490;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__88491,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq88488){
var G__88489 = cljs.core.first.call(null,seq88488);
var seq88488__$1 = cljs.core.next.call(null,seq88488);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__88489,seq88488__$1);
});
...
var G__88497 = arg;
var G__88497__$1 = (((G__88497 instanceof cljs.core.Keyword))?G__88497.fqn:null);
switch (G__88497__$1) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__74901__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__74901__auto__)){
return or__74901__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__74889__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__74901__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__74901__auto__)){
return or__74901__auto__;
} else {
...
var map__88499 = options;
var map__88499__$1 = ((((!((map__88499 == null)))?((((map__88499.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__88499.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__88499):map__88499);
var include_ns_QMARK_ = cljs.core.get.call(null,map__88499__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__88499__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__88499__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__88499__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__88500 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__88500,(0),null);
var fn_name = cljs.core.nth.call(null,vec__88500,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__88500,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__88500,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__88500,(4),null);
var arity = cljs.core.nth.call(null,vec__88500,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__74889__auto__ = protocol_ns;
if(cljs.core.truth_(and__74889__auto__)){
return cljs.core.not.call(null,(function (){var and__74889__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__74901__auto__ = protocol_part;
if(cljs.core.truth_(or__74901__auto__)){
return or__74901__auto__;
} else {
return fn_part;
...
var o__82865__auto__ = f;
return (o__82865__auto__["getBasis"]).call(o__82865__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__74889__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__74889__auto__)){
...
}catch (e88504){var _e__82872__auto__ = e88504;
...
var G__88505 = (obj[cljs.core.first.call(null,path)]);
var G__88506 = cljs.core.rest.call(null,path);
obj = G__88505;
path = G__88506;
continue;
} else {
...
var partition_bits = (function (){var or__74901__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__74901__auto__)){
return or__74901__auto__;
} else {
return (0);
...
return (function (accum,p__88507){
var vec__88508 = p__88507;
var bit = cljs.core.nth.call(null,vec__88508,(0),null);
var protocol = cljs.core.nth.call(null,vec__88508,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__88511){
var vec__88512 = p__88511;
var ns = cljs.core.nth.call(null,vec__88512,(0),null);
var name = cljs.core.nth.call(null,vec__88512,(1),null);
var selector = cljs.core.nth.call(null,vec__88512,(2),null);
...
return (function (p__88516){
var vec__88517 = p__88516;
var munged_name = cljs.core.nth.call(null,vec__88517,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__88517,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__88517,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__88515_SHARP_){
return (obj[cljs.core.first.call(null,p1__88515_SHARP_)]);
});})(name,sorted_matches,vec__88517,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1515122963259
