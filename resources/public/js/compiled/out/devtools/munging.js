...
var o23206 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23206["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23207 = temp__5455__auto____$1;
return (o23207["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__17020__auto__ = f;
return (o__17020__auto__["toString"]).call(o__17020__auto__);
} else {
return "";
}
}catch (e23208){var _ = e23208;
return "";
}});
...
try{var o__17020__auto___23210 = t;
(o__17020__auto___23210["cljs$lang$ctorPrWriter"]).call(o__17020__auto___23210,t,writer);
}catch (e23209){var __23211 = e23209;
}
...
var char_code = (function (){var o__17020__auto__ = (new String(char$));
return (o__17020__auto__["charCodeAt"]).call(o__17020__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__17020__auto__ = String;
return (o__17020__auto__["fromCharCode"]).call(o__17020__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23212 = num_code;
switch (G__23212) {
case (1):
return (185);
...
var o__17020__auto__ = String;
return (o__17020__auto__["fromCharCode"]).call(o__17020__auto__,superscript_code);
});
/**
...
}catch (e23214){var _e__17027__auto__ = e23214;
return false;
}})())){
...
var vec__23215 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23215,(0),null);
...
var or__8359__auto__ = (function (){var temp__5455__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5455__auto__)){
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23218 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23218["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23219 = temp__5455__auto____$1;
return (o23219["nameToPath"]);
} else {
return null;
}
} else {
...
var len__9636__auto___23226 = arguments.length;
var i__9637__auto___23227 = (0);
while(true){
if((i__9637__auto___23227 < len__9636__auto___23226)){
args__9643__auto__.push((arguments[i__9637__auto___23227]));

var G__23228 = (i__9637__auto___23227 + (1));
i__9637__auto___23227 = G__23228;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__9644__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23222){
var vec__23223 = p__23222;
var ns_detector = cljs.core.nth.call(null,vec__23223,(0),null);
var effective_detector = (function (){var or__8359__auto__ = ns_detector;
if(cljs.core.truth_(or__8359__auto__)){
return or__8359__auto__;
} else {
...
var G__23229 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23230 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23229;
remaining_tokens = G__23230;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23220){
var G__23221 = cljs.core.first.call(null,seq23220);
var seq23220__$1 = cljs.core.next.call(null,seq23220);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__23221,seq23220__$1);
});
...
var vec__23234 = cljs.core.split_with.call(null,(function (p1__23233_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23233_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23234,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23234,(1),null);
...
var vec__23237 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23237,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23237,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23240 = cljs.core.rest.call(null,remaining_tokens);
var G__23241 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23240;
name_tokens = G__23241;
continue;
} else {
...
var vec__23244 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23244,(0),null);
var arity = cljs.core.nth.call(null,vec__23244,(1),null);
var vec__23247 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23247,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23247,(1),null);
var vec__23250 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23250,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23250,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23250,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23250,(3),null);
...
var vec__23256 = result;
var munged_ns = cljs.core.nth.call(null,vec__23256,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23256,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23256,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23256,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23256,(4),null);
var arity = cljs.core.nth.call(null,vec__23256,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23260 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23260,(0),null);
var args = cljs.core.nth.call(null,vec__23260,(1),null);
var vec__23263 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23263,(0),null);
var name = cljs.core.nth.call(null,vec__23263,(1),null);
...
var G__23266 = (arity + (1));
var G__23267 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23268){
var vec__23269 = p__23268;
var arity = cljs.core.nth.call(null,vec__23269,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23269,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__8359__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__8359__auto__)){
return or__8359__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__23272_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23273_SHARP_);
...
var args__9643__auto__ = [];
var len__9636__auto___23280 = arguments.length;
var i__9637__auto___23281 = (0);
while(true){
if((i__9637__auto___23281 < len__9636__auto___23280)){
args__9643__auto__.push((arguments[i__9637__auto___23281]));

var G__23282 = (i__9637__auto___23281 + (1));
i__9637__auto___23281 = G__23282;
continue;
} else {
}
break;
...
var argseq__9644__auto__ = ((((1) < args__9643__auto__.length))?(new cljs.core.IndexedSeq(args__9643__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__9644__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23276){
var vec__23277 = p__23276;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23277,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23274){
var G__23275 = cljs.core.first.call(null,seq23274);
var seq23274__$1 = cljs.core.next.call(null,seq23274);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__23275,seq23274__$1);
});
...
var G__23283 = arg;
var G__23283__$1 = (((G__23283 instanceof cljs.core.Keyword))?G__23283.fqn:null);
switch (G__23283__$1) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__8359__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__8359__auto__)){
return or__8359__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__8347__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__8359__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__8359__auto__)){
return or__8359__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23285__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23285__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23285__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23285__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23286 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23286,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23286,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23286,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23286,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23286,(4),null);
var arity = cljs.core.nth.call(null,vec__23286,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__8347__auto__ = protocol_ns;
if(cljs.core.truth_(and__8347__auto__)){
return cljs.core.not.call(null,(function (){var and__8347__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__8359__auto__ = protocol_part;
if(cljs.core.truth_(or__8359__auto__)){
return or__8359__auto__;
} else {
return fn_part;
...
var o__17020__auto__ = f;
return (o__17020__auto__["getBasis"]).call(o__17020__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__8347__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__8347__auto__)){
...
}catch (e23290){var _e__17027__auto__ = e23290;
...
var G__23291 = (obj[cljs.core.first.call(null,path)]);
var G__23292 = cljs.core.rest.call(null,path);
obj = G__23291;
path = G__23292;
continue;
} else {
...
var partition_bits = (function (){var or__8359__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__8359__auto__)){
return or__8359__auto__;
} else {
return (0);
...
return (function (accum,p__23293){
var vec__23294 = p__23293;
var bit = cljs.core.nth.call(null,vec__23294,(0),null);
var protocol = cljs.core.nth.call(null,vec__23294,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23297){
...
var selector = cljs.core.nth.call(null,vec__23298,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__23303,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23303,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23303,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23301_SHARP_){
return (obj[cljs.core.first.call(null,p1__23301_SHARP_)]);
});})(name,sorted_matches,vec__23303,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1521112601993
