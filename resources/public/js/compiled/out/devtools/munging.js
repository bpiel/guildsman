...
var o25825 = temp__6736__auto__;
var temp__6736__auto____$1 = (o25825["core"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o25826 = temp__6736__auto____$1;
return (o25826["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__19323__auto___25829 = t;
(o__19323__auto___25829["cljs$lang$ctorPrWriter"]).call(o__19323__auto___25829,t,writer);
}catch (e25828){var __25830 = e25828;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__25831 = num_code;
switch (G__25831) {
case (1):
return (185);
...
}catch (e25833){var _e__19330__auto__ = e25833;
return false;
}})())){
...
var vec__25834 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__25834,(0),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var o25837 = temp__6736__auto__;
var temp__6736__auto____$1 = (o25837["dependencies_"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o25838 = temp__6736__auto____$1;
return (o25838["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__25841){
var vec__25842 = p__25841;
var ns_detector = cljs.core.nth.call(null,vec__25842,(0),null);
...
var G__25848 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__25849 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__25848;
remaining_tokens = G__25849;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq25839){
var G__25840 = cljs.core.first.call(null,seq25839);
var seq25839__$1 = cljs.core.next.call(null,seq25839);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__25840,seq25839__$1);
});
...
var vec__25853 = cljs.core.split_with.call(null,(function (p1__25852_SHARP_){
return cljs.core.not_EQ_.call(null,p1__25852_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__25853,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__25853,(1),null);
...
var vec__25856 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__25856,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__25856,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__25859 = cljs.core.rest.call(null,remaining_tokens);
var G__25860 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__25859;
name_tokens = G__25860;
continue;
} else {
...
var vec__25863 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__25863,(0),null);
var arity = cljs.core.nth.call(null,vec__25863,(1),null);
var vec__25866 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__25866,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__25866,(1),null);
var vec__25869 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__25869,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__25869,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__25869,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__25869,(3),null);
...
var vec__25875 = result;
var munged_ns = cljs.core.nth.call(null,vec__25875,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__25875,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__25875,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__25875,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__25875,(4),null);
var arity = cljs.core.nth.call(null,vec__25875,(5),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var vec__25879 = temp__6736__auto__;
var munged_name = cljs.core.nth.call(null,vec__25879,(0),null);
var args = cljs.core.nth.call(null,vec__25879,(1),null);
var vec__25882 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__25882,(0),null);
var name = cljs.core.nth.call(null,vec__25882,(1),null);
...
var G__25885 = (arity + (1));
var G__25886 = (function (){var temp__6736__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__6736__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25887){
var vec__25888 = p__25887;
var arity = cljs.core.nth.call(null,vec__25888,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__25888,(1),null);
...
return cljs.core.get.call(null,arities,p1__25891_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__25892_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25895){
var vec__25896 = p__25895;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25896,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25893){
var G__25894 = cljs.core.first.call(null,seq25893);
var seq25893__$1 = cljs.core.next.call(null,seq25893);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__25894,seq25893__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__25904__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25904__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25904__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25904__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25905 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25905,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25905,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25905,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25905,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25905,(4),null);
var arity = cljs.core.nth.call(null,vec__25905,(5),null);
...
var G__25910 = (obj[cljs.core.first.call(null,path)]);
var G__25911 = cljs.core.rest.call(null,path);
obj = G__25910;
path = G__25911;
continue;
} else {
...
return (function (accum,p__25912){
var vec__25913 = p__25912;
var bit = cljs.core.nth.call(null,vec__25913,(0),null);
var protocol = cljs.core.nth.call(null,vec__25913,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25916){
var vec__25917 = p__25916;
var ns = cljs.core.nth.call(null,vec__25917,(0),null);
var name = cljs.core.nth.call(null,vec__25917,(1),null);
var selector = cljs.core.nth.call(null,vec__25917,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__25922,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25922,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__25922,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__25920_SHARP_){
return (obj[cljs.core.first.call(null,p1__25920_SHARP_)]);
});})(name,sorted_matches,vec__25922,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1506896689469
