...
var o76281 = temp__5455__auto__;
var temp__5455__auto____$1 = (o76281["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o76282 = temp__5455__auto____$1;
return (o76282["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__70726__auto__ = f;
return (o__70726__auto__["toString"]).call(o__70726__auto__);
} else {
return "";
}
}catch (e76283){var _ = e76283;
return "";
}});
...
try{var o__70726__auto___76285 = t;
(o__70726__auto___76285["cljs$lang$ctorPrWriter"]).call(o__70726__auto___76285,t,writer);
}catch (e76284){var __76286 = e76284;
}
...
var char_code = (function (){var o__70726__auto__ = (new String(char$));
return (o__70726__auto__["charCodeAt"]).call(o__70726__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__70726__auto__ = String;
return (o__70726__auto__["fromCharCode"]).call(o__70726__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__76287 = num_code;
switch (G__76287) {
case (1):
return (185);
...
var o__70726__auto__ = String;
return (o__70726__auto__["fromCharCode"]).call(o__70726__auto__,superscript_code);
});
/**
...
}catch (e76289){var _e__70733__auto__ = e76289;
return false;
}})())){
...
var vec__76290 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__76290,(0),null);
...
var or__62761__auto__ = (function (){var temp__5455__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5455__auto__)){
...
if(cljs.core.truth_(temp__5455__auto__)){
var o76293 = temp__5455__auto__;
var temp__5455__auto____$1 = (o76293["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o76294 = temp__5455__auto____$1;
return (o76294["nameToPath"]);
} else {
return null;
}
} else {
...
var len__64038__auto___76301 = arguments.length;
var i__64039__auto___76302 = (0);
while(true){
if((i__64039__auto___76302 < len__64038__auto___76301)){
args__64045__auto__.push((arguments[i__64039__auto___76302]));

var G__76303 = (i__64039__auto___76302 + (1));
i__64039__auto___76302 = G__76303;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__64046__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__76297){
var vec__76298 = p__76297;
var ns_detector = cljs.core.nth.call(null,vec__76298,(0),null);
var effective_detector = (function (){var or__62761__auto__ = ns_detector;
if(cljs.core.truth_(or__62761__auto__)){
return or__62761__auto__;
} else {
...
var G__76304 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__76305 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__76304;
remaining_tokens = G__76305;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq76295){
var G__76296 = cljs.core.first.call(null,seq76295);
var seq76295__$1 = cljs.core.next.call(null,seq76295);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__76296,seq76295__$1);
});
...
var vec__76309 = cljs.core.split_with.call(null,(function (p1__76308_SHARP_){
return cljs.core.not_EQ_.call(null,p1__76308_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__76309,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__76309,(1),null);
...
var vec__76312 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__76312,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__76312,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__76315 = cljs.core.rest.call(null,remaining_tokens);
var G__76316 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__76315;
name_tokens = G__76316;
continue;
} else {
...
var vec__76319 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__76319,(0),null);
var arity = cljs.core.nth.call(null,vec__76319,(1),null);
var vec__76322 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__76322,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__76322,(1),null);
var vec__76325 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__76325,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__76325,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__76325,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__76325,(3),null);
...
var vec__76331 = result;
var munged_ns = cljs.core.nth.call(null,vec__76331,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__76331,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__76331,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__76331,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__76331,(4),null);
var arity = cljs.core.nth.call(null,vec__76331,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__76335 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__76335,(0),null);
var args = cljs.core.nth.call(null,vec__76335,(1),null);
var vec__76338 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__76338,(0),null);
var name = cljs.core.nth.call(null,vec__76338,(1),null);
...
var G__76341 = (arity + (1));
var G__76342 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__76343){
var vec__76344 = p__76343;
var arity = cljs.core.nth.call(null,vec__76344,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__76344,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__62761__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__62761__auto__)){
return or__62761__auto__;
} else {
...
return (function (p1__76347_SHARP_){
return cljs.core.get.call(null,arities,p1__76347_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__76348_SHARP_){
return cljs.core.drop.call(null,(2),p1__76348_SHARP_);
...
var args__64045__auto__ = [];
var len__64038__auto___76355 = arguments.length;
var i__64039__auto___76356 = (0);
while(true){
if((i__64039__auto___76356 < len__64038__auto___76355)){
args__64045__auto__.push((arguments[i__64039__auto___76356]));

var G__76357 = (i__64039__auto___76356 + (1));
i__64039__auto___76356 = G__76357;
continue;
} else {
}
break;
...
var argseq__64046__auto__ = ((((1) < args__64045__auto__.length))?(new cljs.core.IndexedSeq(args__64045__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__64046__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__76351){
var vec__76352 = p__76351;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__76352,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq76349){
var G__76350 = cljs.core.first.call(null,seq76349);
var seq76349__$1 = cljs.core.next.call(null,seq76349);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__76350,seq76349__$1);
});
...
var G__76358 = arg;
var G__76358__$1 = (((G__76358 instanceof cljs.core.Keyword))?G__76358.fqn:null);
switch (G__76358__$1) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__62761__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__62761__auto__)){
return or__62761__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__62749__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__62761__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__62761__auto__)){
return or__62761__auto__;
} else {
...
var map__76360 = options;
var map__76360__$1 = ((((!((map__76360 == null)))?((((map__76360.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76360.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__76360):map__76360);
var include_ns_QMARK_ = cljs.core.get.call(null,map__76360__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__76360__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__76360__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__76360__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__76361 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__76361,(0),null);
var fn_name = cljs.core.nth.call(null,vec__76361,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__76361,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__76361,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__76361,(4),null);
var arity = cljs.core.nth.call(null,vec__76361,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__62749__auto__ = protocol_ns;
if(cljs.core.truth_(and__62749__auto__)){
return cljs.core.not.call(null,(function (){var and__62749__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__62761__auto__ = protocol_part;
if(cljs.core.truth_(or__62761__auto__)){
return or__62761__auto__;
} else {
return fn_part;
...
var o__70726__auto__ = f;
return (o__70726__auto__["getBasis"]).call(o__70726__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__62749__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__62749__auto__)){
...
}catch (e76365){var _e__70733__auto__ = e76365;
...
var G__76366 = (obj[cljs.core.first.call(null,path)]);
var G__76367 = cljs.core.rest.call(null,path);
obj = G__76366;
path = G__76367;
continue;
} else {
...
var partition_bits = (function (){var or__62761__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__62761__auto__)){
return or__62761__auto__;
} else {
return (0);
...
return (function (accum,p__76368){
var vec__76369 = p__76368;
var bit = cljs.core.nth.call(null,vec__76369,(0),null);
var protocol = cljs.core.nth.call(null,vec__76369,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__76372){
var vec__76373 = p__76372;
var ns = cljs.core.nth.call(null,vec__76373,(0),null);
var name = cljs.core.nth.call(null,vec__76373,(1),null);
var selector = cljs.core.nth.call(null,vec__76373,(2),null);
...
return (function (p__76377){
var vec__76378 = p__76377;
var munged_name = cljs.core.nth.call(null,vec__76378,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__76378,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__76378,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__76376_SHARP_){
return (obj[cljs.core.first.call(null,p1__76376_SHARP_)]);
});})(name,sorted_matches,vec__76378,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1514950342091
