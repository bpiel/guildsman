...
var o26007 = temp__6736__auto__;
var temp__6736__auto____$1 = (o26007["core"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o26008 = temp__6736__auto____$1;
return (o26008["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19447__auto__ = f;
return (o__19447__auto__["toString"]).call(o__19447__auto__);
} else {
return "";
}
...
try{var o__19447__auto___26011 = t;
(o__19447__auto___26011["cljs$lang$ctorPrWriter"]).call(o__19447__auto___26011,t,writer);
}catch (e26010){var __26012 = e26010;
}
...
var char_code = (function (){var o__19447__auto__ = (new String(char$));
return (o__19447__auto__["charCodeAt"]).call(o__19447__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19447__auto__ = String;
return (o__19447__auto__["fromCharCode"]).call(o__19447__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__26013 = num_code;
switch (G__26013) {
case (1):
return (185);
...
var o__19447__auto__ = String;
return (o__19447__auto__["fromCharCode"]).call(o__19447__auto__,superscript_code);
});
/**
...
}catch (e26015){var _e__19454__auto__ = e26015;
return false;
}})())){
...
var vec__26016 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__26016,(0),null);
...
var or__9950__auto__ = (function (){var temp__6736__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__6736__auto__)){
...
if(cljs.core.truth_(temp__6736__auto__)){
var o26019 = temp__6736__auto__;
var temp__6736__auto____$1 = (o26019["dependencies_"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o26020 = temp__6736__auto____$1;
return (o26020["nameToPath"]);
} else {
return null;
}
} else {
...
var len__11227__auto___26027 = arguments.length;
var i__11228__auto___26028 = (0);
while(true){
if((i__11228__auto___26028 < len__11227__auto___26027)){
args__11234__auto__.push((arguments[i__11228__auto___26028]));

var G__26029 = (i__11228__auto___26028 + (1));
i__11228__auto___26028 = G__26029;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__11235__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__26023){
var vec__26024 = p__26023;
var ns_detector = cljs.core.nth.call(null,vec__26024,(0),null);
var effective_detector = (function (){var or__9950__auto__ = ns_detector;
if(cljs.core.truth_(or__9950__auto__)){
return or__9950__auto__;
} else {
...
var G__26030 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__26031 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__26030;
remaining_tokens = G__26031;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq26021){
var G__26022 = cljs.core.first.call(null,seq26021);
var seq26021__$1 = cljs.core.next.call(null,seq26021);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__26022,seq26021__$1);
});
...
var vec__26035 = cljs.core.split_with.call(null,(function (p1__26034_SHARP_){
return cljs.core.not_EQ_.call(null,p1__26034_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__26035,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__26035,(1),null);
...
var vec__26038 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__26038,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__26038,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__26041 = cljs.core.rest.call(null,remaining_tokens);
var G__26042 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__26041;
name_tokens = G__26042;
continue;
} else {
...
var vec__26045 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__26045,(0),null);
var arity = cljs.core.nth.call(null,vec__26045,(1),null);
var vec__26048 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__26048,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__26048,(1),null);
var vec__26051 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__26051,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__26051,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__26051,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__26051,(3),null);
...
var vec__26057 = result;
var munged_ns = cljs.core.nth.call(null,vec__26057,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__26057,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__26057,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__26057,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__26057,(4),null);
var arity = cljs.core.nth.call(null,vec__26057,(5),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var vec__26061 = temp__6736__auto__;
var munged_name = cljs.core.nth.call(null,vec__26061,(0),null);
var args = cljs.core.nth.call(null,vec__26061,(1),null);
var vec__26064 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__26064,(0),null);
var name = cljs.core.nth.call(null,vec__26064,(1),null);
...
var G__26067 = (arity + (1));
var G__26068 = (function (){var temp__6736__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__6736__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__26069){
var vec__26070 = p__26069;
var arity = cljs.core.nth.call(null,vec__26070,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__26070,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__9950__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__9950__auto__)){
return or__9950__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__26073_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__26074_SHARP_);
...
var args__11234__auto__ = [];
var len__11227__auto___26081 = arguments.length;
var i__11228__auto___26082 = (0);
while(true){
if((i__11228__auto___26082 < len__11227__auto___26081)){
args__11234__auto__.push((arguments[i__11228__auto___26082]));

var G__26083 = (i__11228__auto___26082 + (1));
i__11228__auto___26082 = G__26083;
continue;
} else {
}
break;
...
var argseq__11235__auto__ = ((((1) < args__11234__auto__.length))?(new cljs.core.IndexedSeq(args__11234__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__11235__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__26077){
var vec__26078 = p__26077;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__26078,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq26075){
var G__26076 = cljs.core.first.call(null,seq26075);
var seq26075__$1 = cljs.core.next.call(null,seq26075);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__26076,seq26075__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__9950__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__9950__auto__)){
return or__9950__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__9938__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__9950__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__9950__auto__)){
return or__9950__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__26086__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__26086__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__26086__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__26086__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__26087 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__26087,(0),null);
var fn_name = cljs.core.nth.call(null,vec__26087,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__26087,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__26087,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__26087,(4),null);
var arity = cljs.core.nth.call(null,vec__26087,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__9938__auto__ = protocol_ns;
if(cljs.core.truth_(and__9938__auto__)){
return cljs.core.not.call(null,(function (){var and__9938__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__9950__auto__ = protocol_part;
if(cljs.core.truth_(or__9950__auto__)){
return or__9950__auto__;
} else {
return fn_part;
...
var o__19447__auto__ = f;
return (o__19447__auto__["getBasis"]).call(o__19447__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__9938__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__9938__auto__)){
...
}catch (e26091){var _e__19454__auto__ = e26091;
...
var G__26092 = (obj[cljs.core.first.call(null,path)]);
var G__26093 = cljs.core.rest.call(null,path);
obj = G__26092;
path = G__26093;
continue;
} else {
...
var partition_bits = (function (){var or__9950__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__9950__auto__)){
return or__9950__auto__;
} else {
return (0);
...
return (function (accum,p__26094){
var vec__26095 = p__26094;
var bit = cljs.core.nth.call(null,vec__26095,(0),null);
var protocol = cljs.core.nth.call(null,vec__26095,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__26098){
var vec__26099 = p__26098;
var ns = cljs.core.nth.call(null,vec__26099,(0),null);
var name = cljs.core.nth.call(null,vec__26099,(1),null);
var selector = cljs.core.nth.call(null,vec__26099,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__26104,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__26104,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__26104,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__26102_SHARP_){
return (obj[cljs.core.first.call(null,p1__26102_SHARP_)]);
});})(name,sorted_matches,vec__26104,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1506917878044
