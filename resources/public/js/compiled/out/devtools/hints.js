...
var reader = (function (){var or__8359__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__8359__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__8359__auto__)){
return or__8359__auto__;
} else {
return (128);
...
}catch (e24957){var _e = e24957;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___24960 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___24960)){
var seen_errors_24961 = temp__5455__auto___24960;
if(cljs.core.truth_(seen_errors_24961.has(self))){
} else {
seen_errors_24961.add(self);

var temp__5457__auto___24962 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___24962)){
var sense_24963 = temp__5457__auto___24962;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_24963)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1521112605893
