...
var reader = (function (){var or__62761__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__62761__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__62761__auto__)){
return or__62761__auto__;
} else {
return (128);
...
var map__78033 = top_item;
var map__78033__$1 = ((((!((map__78033 == null)))?((((map__78033.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__78033.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__78033):map__78033);
var file = cljs.core.get.call(null,map__78033__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__78033__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__78033__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e78032){var _e = e78032;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___78035 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___78035)){
var seen_errors_78036 = temp__5455__auto___78035;
if(cljs.core.truth_(seen_errors_78036.has(self))){
} else {
seen_errors_78036.add(self);

var temp__5457__auto___78037 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___78037)){
var sense_78038 = temp__5457__auto___78037;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_78038)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1514950346022
