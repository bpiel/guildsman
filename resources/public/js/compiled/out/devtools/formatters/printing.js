...
var len__64038__auto___76404 = arguments.length;
var i__64039__auto___76405 = (0);
while(true){
if((i__64039__auto___76405 < len__64038__auto___76404)){
args__64045__auto__.push((arguments[i__64039__auto___76405]));

var G__76406 = (i__64039__auto___76405 + (1));
i__64039__auto___76405 = G__76406;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__64046__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq76401){
var G__76402 = cljs.core.first.call(null,seq76401);
var seq76401__$1 = cljs.core.next.call(null,seq76401);
var G__76403 = cljs.core.first.call(null,seq76401__$1);
var seq76401__$2 = cljs.core.next.call(null,seq76401__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__76402,G__76403,seq76401__$2);
});
...
if(cljs.core.truth_((function (){var or__62761__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__63432__auto__,writer__63433__auto__,opt__63434__auto__){
return cljs.core._write.call(null,writer__63433__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__62749__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__62749__auto__){
var or__62761__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__62761__auto__)){
return or__62761__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__76407_SHARP_){
return !((cljs.core.meta.call(null,p1__76407_SHARP_) == null));
})))){
...
var map__76408 = opts;
var map__76408__$1 = ((((!((map__76408 == null)))?((((map__76408.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76408.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__76408):map__76408);
var markup_db = cljs.core.get.call(null,map__76408__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__62761__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e76412){var _e__70733__auto__ = e76412;
return false;
}})();
if(cljs.core.truth_(or__62761__auto__)){
return or__62761__auto__;
...
}catch (e76414){var _e__70733__auto__ = e76414;
return false;
}}
})())){
...
var _STAR_current_state_STAR_76416 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__76417 = opts;
var map__76417__$1 = ((((!((map__76417 == null)))?((((map__76417.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76417.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__76417):map__76417);
var markup_db = cljs.core.get.call(null,map__76417__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_76416;
}});
...
;
var temp__5455__auto___76421 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___76421)){
var managed_print_level_76422 = temp__5455__auto___76421;
var _STAR_print_level_STAR_76420_76423 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_76422;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_76420_76423,managed_print_level_76422,temp__5455__auto___76421,writer,opts,job_fn){
return (function (p1__76419_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__76419_SHARP_,null);
});})(_STAR_print_level_STAR_76420_76423,managed_print_level_76422,temp__5455__auto___76421,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_76420_76423;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1514950342296
