...
var len__11227__auto___26138 = arguments.length;
var i__11228__auto___26139 = (0);
while(true){
if((i__11228__auto___26139 < len__11227__auto___26138)){
args__11234__auto__.push((arguments[i__11228__auto___26139]));

var G__26140 = (i__11228__auto___26139 + (1));
i__11228__auto___26139 = G__26140;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__11235__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq26135){
var G__26136 = cljs.core.first.call(null,seq26135);
var seq26135__$1 = cljs.core.next.call(null,seq26135);
var G__26137 = cljs.core.first.call(null,seq26135__$1);
var seq26135__$2 = cljs.core.next.call(null,seq26135__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__26136,G__26137,seq26135__$2);
});
...
if(cljs.core.truth_((function (){var or__9950__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__10621__auto__,writer__10622__auto__,opt__10623__auto__){
return cljs.core._write.call(null,writer__10622__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__9938__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__9938__auto__){
var or__9950__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__9950__auto__)){
return or__9950__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__26141_SHARP_){
return !((cljs.core.meta.call(null,p1__26141_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__26142__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__9950__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e26146){var _e__19454__auto__ = e26146;
return false;
}})();
if(cljs.core.truth_(or__9950__auto__)){
return or__9950__auto__;
...
}catch (e26148){var _e__19454__auto__ = e26148;
return false;
}}
})())){
...
var _STAR_current_state_STAR_26150 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__26151 = opts;
...
var markup_db = cljs.core.get.call(null,map__26151__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_26150;
}});
...
;
var temp__6736__auto___26155 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__6736__auto___26155)){
var managed_print_level_26156 = temp__6736__auto___26155;
var _STAR_print_level_STAR_26154_26157 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_26156;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_26154_26157,managed_print_level_26156,temp__6736__auto___26155,writer,opts,job_fn){
return (function (p1__26153_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__26153_SHARP_,null);
});})(_STAR_print_level_STAR_26154_26157,managed_print_level_26156,temp__6736__auto___26155,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_26154_26157;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1506917878191
