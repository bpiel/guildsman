...
var len__76178__auto___88543 = arguments.length;
var i__76179__auto___88544 = (0);
while(true){
if((i__76179__auto___88544 < len__76178__auto___88543)){
args__76185__auto__.push((arguments[i__76179__auto___88544]));

var G__88545 = (i__76179__auto___88544 + (1));
i__76179__auto___88544 = G__88545;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__76186__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq88540){
var G__88541 = cljs.core.first.call(null,seq88540);
var seq88540__$1 = cljs.core.next.call(null,seq88540);
var G__88542 = cljs.core.first.call(null,seq88540__$1);
var seq88540__$2 = cljs.core.next.call(null,seq88540__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__88541,G__88542,seq88540__$2);
});
...
if(cljs.core.truth_((function (){var or__74901__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__75572__auto__,writer__75573__auto__,opt__75574__auto__){
return cljs.core._write.call(null,writer__75573__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__74889__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__74889__auto__){
var or__74901__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__74901__auto__)){
return or__74901__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__88546_SHARP_){
return !((cljs.core.meta.call(null,p1__88546_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__88547__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__74901__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e88551){var _e__82872__auto__ = e88551;
return false;
}})();
if(cljs.core.truth_(or__74901__auto__)){
return or__74901__auto__;
...
}catch (e88553){var _e__82872__auto__ = e88553;
return false;
}}
})())){
...
var _STAR_current_state_STAR_88555 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__88556 = opts;
var map__88556__$1 = ((((!((map__88556 == null)))?((((map__88556.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__88556.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__88556):map__88556);
var markup_db = cljs.core.get.call(null,map__88556__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_88555;
}});
...
;
var temp__5455__auto___88560 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___88560)){
var managed_print_level_88561 = temp__5455__auto___88560;
var _STAR_print_level_STAR_88559_88562 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_88561;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_88559_88562,managed_print_level_88561,temp__5455__auto___88560,writer,opts,job_fn){
return (function (p1__88558_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__88558_SHARP_,null);
});})(_STAR_print_level_STAR_88559_88562,managed_print_level_88561,temp__5455__auto___88560,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_88559_88562;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1515122963461
