...
var len__76178__auto___83877 = arguments.length;
var i__76179__auto___83878 = (0);
while(true){
if((i__76179__auto___83878 < len__76178__auto___83877)){
args__76185__auto__.push((arguments[i__76179__auto___83878]));

var G__83879 = (i__76179__auto___83878 + (1));
i__76179__auto___83878 = G__83879;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__76186__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq83875){
var G__83876 = cljs.core.first.call(null,seq83875);
var seq83875__$1 = cljs.core.next.call(null,seq83875);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__83876,seq83875__$1);
});
...
return (function (p1__83880_SHARP_){
return (p1__83880_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1515122954260
