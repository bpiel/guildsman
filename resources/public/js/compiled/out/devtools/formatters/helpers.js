...
var G__76383 = devtools.prefs.pref.call(null,v);
v = G__76383;
continue;
} else {
return v;
...
var and__62749__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__62749__auto__){
var and__62749__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__62761__auto__ = (function (){try{if(!((value == null))){
...
}catch (e76386){var _e__70733__auto__ = e76386;
return false;
}})();
if(cljs.core.truth_(or__62761__auto__)){
return or__62761__auto__;
} else {
var or__62761__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e76390){var _e__70733__auto__ = e76390;
return false;
}})();
...
}catch (e76392){var _e__70733__auto__ = e76392;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__62749__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__62749__auto__)){
var and__62749__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__62749__auto____$1){
...
var and__62749__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__62749__auto__)){
...
var or__62761__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__62761__auto__)){
return or__62761__auto__;
} else {
...
var and__62749__auto__ = (function (){var or__62761__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__62761__auto__)){
return or__62761__auto__;
} else {
...
var vec__76394 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__76394,(0),null);
var name = cljs.core.nth.call(null,vec__76394,(1),null);
...
var and__62749__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__62749__auto__)){
...
var or__62761__auto__ = typeof value === 'string';
if(or__62761__auto__){
return or__62761__auto__;
} else {
var or__62761__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__76397_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__76397_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1514950342192
