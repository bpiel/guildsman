...
var G__26109 = devtools.prefs.pref.call(null,v);
v = G__26109;
continue;
} else {
return v;
...
var and__9938__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__9938__auto__){
var and__9938__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__9950__auto__ = (function (){try{if(!((value == null))){
...
}catch (e26112){var _e__19454__auto__ = e26112;
return false;
}})();
if(cljs.core.truth_(or__9950__auto__)){
return or__9950__auto__;
} else {
var or__9950__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e26116){var _e__19454__auto__ = e26116;
return false;
}})();
...
}catch (e26118){var _e__19454__auto__ = e26118;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__9938__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__9938__auto__)){
var and__9938__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__9938__auto____$1){
...
var and__9938__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__9938__auto__)){
...
var or__9950__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__9950__auto__)){
return or__9950__auto__;
} else {
...
var and__9938__auto__ = (function (){var or__9950__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__9950__auto__)){
return or__9950__auto__;
} else {
...
var vec__26120 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__26120,(0),null);
var name = cljs.core.nth.call(null,vec__26120,(1),null);
...
var and__9938__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__9938__auto__)){
...
var or__9950__auto__ = typeof value === 'string';
if(or__9950__auto__){
return or__9950__auto__;
} else {
var or__9950__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__26123_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__26123_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1506917878110
