...
var G__88522 = devtools.prefs.pref.call(null,v);
v = G__88522;
continue;
} else {
return v;
...
var and__74889__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__74889__auto__){
var and__74889__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__74901__auto__ = (function (){try{if(!((value == null))){
...
}catch (e88525){var _e__82872__auto__ = e88525;
return false;
}})();
if(cljs.core.truth_(or__74901__auto__)){
return or__74901__auto__;
} else {
var or__74901__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e88529){var _e__82872__auto__ = e88529;
return false;
}})();
...
}catch (e88531){var _e__82872__auto__ = e88531;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__74889__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__74889__auto__)){
var and__74889__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__74889__auto____$1){
...
var and__74889__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__74889__auto__)){
...
var or__74901__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__74901__auto__)){
return or__74901__auto__;
} else {
...
var and__74889__auto__ = (function (){var or__74901__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__74901__auto__)){
return or__74901__auto__;
} else {
...
var vec__88533 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__88533,(0),null);
var name = cljs.core.nth.call(null,vec__88533,(1),null);
...
var and__74889__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__74889__auto__)){
...
var or__74901__auto__ = typeof value === 'string';
if(or__74901__auto__){
return or__74901__auto__;
} else {
var or__74901__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__88536_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__88536_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1515122963360
