...
var G__23308 = devtools.prefs.pref.call(null,v);
v = G__23308;
continue;
} else {
return v;
...
var and__8347__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__8347__auto__){
var and__8347__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__8359__auto__ = (function (){try{if(!((value == null))){
...
}catch (e23311){var _e__17027__auto__ = e23311;
return false;
}})();
if(cljs.core.truth_(or__8359__auto__)){
return or__8359__auto__;
} else {
var or__8359__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e23315){var _e__17027__auto__ = e23315;
return false;
}})();
...
}catch (e23317){var _e__17027__auto__ = e23317;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__8347__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__8347__auto__)){
var and__8347__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__8347__auto____$1){
...
var and__8347__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__8347__auto__)){
...
var or__8359__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__8359__auto__)){
return or__8359__auto__;
} else {
...
var and__8347__auto__ = (function (){var or__8359__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__8359__auto__)){
return or__8359__auto__;
} else {
...
var vec__23319 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__23319,(0),null);
var name = cljs.core.nth.call(null,vec__23319,(1),null);
...
var and__8347__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__8347__auto__)){
...
var or__8359__auto__ = typeof value === 'string';
if(or__8359__auto__){
return or__8359__auto__;
} else {
var or__8359__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__23322_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__23322_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1521112602094
