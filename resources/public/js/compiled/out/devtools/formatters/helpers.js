...
var G__67813 = devtools.prefs.pref.call(null,v);
v = G__67813;
continue;
} else {
return v;
...
var and__52958__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__52958__auto__){
var and__52958__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__52970__auto__ = (function (){try{if(!((value == null))){
...
}catch (e67816){var _e__61846__auto__ = e67816;
return false;
}})();
if(cljs.core.truth_(or__52970__auto__)){
return or__52970__auto__;
} else {
var or__52970__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e67820){var _e__61846__auto__ = e67820;
return false;
}})();
...
}catch (e67822){var _e__61846__auto__ = e67822;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__52958__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__52958__auto__)){
var and__52958__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__52958__auto____$1){
...
var and__52958__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__52958__auto__)){
...
var or__52970__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__52970__auto__)){
return or__52970__auto__;
} else {
...
var and__52958__auto__ = (function (){var or__52970__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__52970__auto__)){
return or__52970__auto__;
} else {
...
var vec__67824 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__67824,(0),null);
var name = cljs.core.nth.call(null,vec__67824,(1),null);
...
var and__52958__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__52958__auto__)){
...
var or__52970__auto__ = typeof value === 'string';
if(or__52970__auto__){
return or__52970__auto__;
} else {
var or__52970__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__67827_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__67827_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1524702425222
