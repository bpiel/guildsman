...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__53641__auto__,writer__53642__auto__,opt__53643__auto__){
return cljs.core._write.call(null,writer__53642__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__56252 = o;
(G__56252[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__56253__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__56253 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__56254__i = 0, G__56254__a = new Array(arguments.length -  0);
while (G__56254__i < G__56254__a.length) {G__56254__a[G__56254__i] = arguments[G__56254__i + 0]; ++G__56254__i;}
  args = new cljs.core.IndexedSeq(G__56254__a,0,null);
} 
return G__56253__delegate.call(this,args);};
G__56253.cljs$lang$maxFixedArity = 0;
G__56253.cljs$lang$applyTo = (function (arglist__56255){
var args = cljs.core.seq(arglist__56255);
return G__56253__delegate(args);
});
G__56253.cljs$core$IFn$_invoke$arity$variadic = G__56253__delegate;
return G__56253;
})()
;
} else {
...
if(cljs.core.truth_((function (){var and__52958__auto__ = !((jsprops == null));
if(and__52958__auto__){
var and__52958__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__56258 = jsprops;
(G__56258["defaultValue"] = value);

(G__56258["onChange"] = ((function (G__56258,v,value,on_change){
return (function (p1__56257_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__56257_SHARP_);
});})(G__56258,v,value,on_change))
);
...
var vec__56261 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__56261,(0),null);
var id = cljs.core.nth.call(null,vec__56261,(1),null);
var class$ = cljs.core.nth.call(null,vec__56261,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___56265 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___56265 == null)){
} else {
var key_56266 = temp__5461__auto___56265;
(jsprops["key"] = key_56266);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__56267 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__56267["name"] = c);
...
var len__54247__auto___56272 = arguments.length;
var i__54248__auto___56273 = (0);
while(true){
if((i__54248__auto___56273 < len__54247__auto___56272)){
args__54254__auto__.push((arguments[i__54248__auto___56273]));

var G__56274 = (i__54248__auto___56273 + (1));
i__54248__auto___56273 = G__56274;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__54255__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq56270){
var G__56271 = cljs.core.first.call(null,seq56270);
var seq56270__$1 = cljs.core.next.call(null,seq56270);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__56271,seq56270__$1);
});
...
break;
default:
var G__56277 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__56277;
continue;
...
var n__54013__auto___56279 = a.length;
var i_56280 = (0);
while(true){
if((i_56280 < n__54013__auto___56279)){
(a[i_56280] = reagent.impl.template.as_element.call(null,(a[i_56280])));

var G__56281 = (i_56280 + (1));
i_56280 = G__56281;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__54013__auto___56282 = a.length;
var i_56283 = (0);
while(true){
if((i_56283 < n__54013__auto___56282)){
var val_56284 = (a[i_56283]);
if((cljs.core.vector_QMARK_.call(null,val_56284)) && ((reagent.impl.template.key_from_vec.call(null,val_56284) == null))){
(o["no-key"] = true);
} else {
}

(a[i_56283] = reagent.impl.template.as_element.call(null,val_56284));

var G__56285 = (i_56283 + (1));
i_56283 = G__56285;
continue;
} else {
}
...
var ctx = ({});
var vec__56286 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__56286,(0),null);
var derefed = cljs.core.nth.call(null,vec__56286,(1),null);
...
var G__56289 = (cljs.core.count.call(null,argv) - first_child);
switch (G__56289) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__56289){
...
//# sourceMappingURL=template.js.map?rel=1524702415676
